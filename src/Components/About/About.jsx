        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="section-subtitle mt-4">
              Building scalable backend systems and real-world products
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            <motion.div variants={itemVariants} className="space-y-6">
              <div className="prose prose-lg dark:prose-invert max-w-none">
                ...
                I build backend systems and full-stack applications that handle real-world workflows.
                Currently, I work as a Full Stack Developer at Amgen, where I develop scalable backend services and APIs for enterprise healthcare systems. Alongside this, I built Edkonnect, a tutoring marketplace platform that manages end-to-end workflows including user onboarding, scheduling, payments, and communication.
                My work focuses on backend engineering, designing APIs, handling data workflows, and building systems that are secure, reliable, and production-ready. I’ve worked with Java, Python, and TypeScript to build scalable services, integrate third-party platforms like Stripe, and deploy applications on AWS.
                I care about building systems that don’t just work, but scale, from handling multi-role workflows to ensuring consistent data flow across distributed services.
                </p>
